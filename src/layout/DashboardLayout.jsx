...
const DashboardLayout = () => {
  const activeClass =
    "text-white bg-blue-700 shadow-lg py-2 hover:bg-blue-700 hover:text-white hover:shadow-lg hover:shadow-blue-200 shadow-blue-300 duration-300 focus:bg-blue-700";
  const inactiveClass =
    "py-2 hover:bg-blue-700 hover:text-white hover:shadow-lg hover:shadow-blue-200 shadow-blue-300 duration-300 focus:bg-blue-700";
  return (
    <>
      <Helmet>
        ...
        <div className="drawer-side">
          ...
          <ul className="menu p-4 w-80 h-full text-xl bg-[#AC9C63] text-white bg-gradient-to-bl from-blue-500 to-purple-600">
            ...
            <li>
              ...
              >
                {" "}
                <MdProductionQuantityLimits /> Add Product{" "}
              </NavLink>
            </li>
          </ul>
        </div>
