...
const handleLogout =()=>{
  ...
  <div className="navbar-start">
    ...
    <Link to='/' className="btn btn-ghost normal-case text-xl">ShopWave</Link>
  </div>
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 text-lg">
      <li><NavLink className={({ isActive }) => (isActive ? "active-link" : "focus:bg-transparent hover:bg-transparent hover:text-blue-400")} to='/'>Home</NavLink></li> 
      <li><NavLink className= 'focus:bg-transparent hover:bg-transparent hover:text-blue-400' to = '/instructor'>Products</NavLink></li>
